...
function StartMessageReceiver ()
{
	...
	$runspace_message_receive.SessionStateProxy.setVariable("clients", $client)
	$runspace_message_receive.SessionStateProxy.setVariable("remove_client_queue", $server_stream)
